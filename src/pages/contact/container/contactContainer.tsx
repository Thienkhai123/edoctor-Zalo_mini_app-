...
const ContactContainer = () => {
	...
	return (
		<Box>
			<div className="flex flex-col gap-5 items-center mt-[100px] mx-2">
				<svg
					fill="#147aad"
					width="64px"
					height="64px"
				...
				>
					...
					<g id="SVGRepo_iconCarrier">
						...
						<g id="_x32_4_office"></g> <g id="_x32_3_pin"></g>{" "}
				...
				<Button
					...
					className=" text-base w-[250px] text-white bg-[#1479FF] font-bold text-center rounded-lg"
				>
					Liên hệ bác sĩ
				</Button>
			</div>
