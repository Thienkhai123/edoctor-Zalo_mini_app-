...
const DangerComponent = ({
	...
	key = "RLCHLP",
	handleKeyActive = (key: string, type: string) => {},
	keyActive = {
		key: "",
		type: "",
	},
	...
	return (
		<Box>
			...
			<div className="flex gap-3 justify-center my-3">
				<div
					onClick={() => handleKeyActive(key, "No")}
					className={` flex justify-center gap-[3px] items-center rounded-[16px] w-[101px] py-[10px] bg-[#E7F2FF]`}
				>
				...
				<div
					onClick={() => handleKeyActive(key, "Yes")}
					className={` flex justify-center gap-[3px] items-center rounded-[16px] w-[101px] py-[10px] bg-[#E7F2FF]`}
				>
