	...
	return (
		<Box>
			...
			<div className="flex gap-3 justify-center my-3">
				<div className="flex justify-center gap-[3px] items-center rounded-[16px] w-[101px] py-[10px] bg-[#E7F2FF] ">
...
export default DangerMinComponent
