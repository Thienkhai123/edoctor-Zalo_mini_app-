...
const DangerTypeFlexComponent = ({
	...
	return (
		<Box className="flex justify-between ">
			...
			<div className="flex gap-3 justify-center max-h-[24px] mt-2">
				<div
					onClick={() =>
					...
					}  flex justify-center gap-[3px]  items-center py-[1px] rounded-[16px] w-[71px]  bg-[#E7F2FF]`}
				>
				...
				<div
					onClick={() =>
						handleData(formTemplateId, name, false, type, "")
					}
					className={`${
...
export default DangerTypeFlexComponent
